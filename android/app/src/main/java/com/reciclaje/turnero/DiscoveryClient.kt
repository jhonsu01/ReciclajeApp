...
/**
 * Autodescubrimiento del servidor: envía "RECICLAJE_DISCOVER" por broadcast UDP
 * al puerto 18300 y espera la respuesta {tipo:"RECICLAJE_SERVER", ip, puerto, nombre}.
 * Debe ejecutarse fuera del hilo principal.
 */
object DiscoveryClient {

    private const val PUERTO = 18300
    private const val MENSAJE = "RECICLAJE_DISCOVER"
        ...
        try {
            ...
            while (System.currentTimeMillis() < limite) {
                ...
                try {
                    ...
                    if (json.optString("tipo") == "RECICLAJE_SERVER" && json.has("ip")) {
                        return json
                    }
